<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Analisi.aspx.vb" Inherits="Focolaio_Analisi"  MasterPageFile="~/_MasterPage/Template.master"
EnableEventValidation="false"
UICulture="it" Culture="it-IT"
ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenuto" Runat="Server">
    <div class="splitd"  >
   <div class="pag_link" >
           Simiweb -> Focolaio -> <b>Analisi (1 di 2)</b></div >
           <p>
...
<p>
    <asp:RadioButtonList ID="TipodataRiferimento" runat="server"  CssClass="checkBox">        
                <asp:ListItem Text="data inizio epidemia/data segnalazione" Value="1" Selected="True"></asp:ListItem>
