<%@ Page Title="" Language="VB" MasterPageFile="~/_MasterPage/Template.master" AutoEventWireup="false" CodeFile="EditFocolaio.aspx.vb" 
EnableEventValidation="false"
EnableViewState="true"
ClientIDMode="Static"
Inherits="Focolaio_EditFocolaio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenuto" Runat="Server">
   <div class="splitd"  >
         <div class="pag_link" ><!--a href="">
           home</a-->
           Simiweb -> Focolaio -> <b>Aggiorna</b>
        </div >    
            <asp:Label ID="lblErrore" runat="server"  Visible="false" CssClass="alert"></asp:Label>
            <asp:Label ID="dataweb" runat="server"  Visible="false" CssClass="alert"></asp:Label>
            <br />
            <br />
          ...
          <p>
                ...
                <asp:RequiredFieldValidator ID="reqNumeroCasi" runat="server" ControlToValidate="numerocasi" Text="*" ValidationGroup="form"></asp:RequiredFieldValidator>
          </p>
          <p>
                ...
                <asp:DropDownList ID="LuogoOrigine" runat="server" CssClass="textBox">
