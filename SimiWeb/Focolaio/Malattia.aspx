...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenuto" Runat="Server">
    <div class="splitd"  >
         <div class="pag_link" ><!--a href="">
           home</a-->
           Simiweb -> Focolaio -> <b>Nuovo Focolaio (1 di 2)</b>
        </div >                    
        <br />
        <h3>Selezionare la malattia che si vuole notificare</h3>
        <br />
        ...
        <asp:Repeater ID="rptMalattie" runat="server">
                ...
                <ItemTemplate>
                        ...
                        <a    href="Focolaio.aspx?idMalattia=<%# DataBinder.Eval(Container.DataItem,"id_malattia")%>&malattia=<%# DataBinder.Eval(Container.DataItem,"DescrizioneBreve")%>" >
