...
Partial Class Notifica_Malattia
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            'rptMalattie.DataSource = mobjMalattie.GetAllMalattieList("mal")
            rptMalattie.DataSource = mobjMalattie.GetAuthMallatieList(User.Identity.Name)
    ...
    Protected Function AddBreak() As String
        ...
        If _lastValue <> currValue Then
            ...
            'strRet = "</br><label id='#" + currValue + "' name='" + currValue + "'><b>" + currValue + "</b></label><hr>"
            strRet = "</br><a name='" + currValue + "'><b>" + currValue + "</b></label><hr>"
            Return strRet
        Else
            Return String.Empty
        End If
