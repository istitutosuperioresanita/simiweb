<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AnalisiReport.aspx.vb" Inherits="Iss_AnalisiReport" MasterPageFile="~/_MasterPage/TemplateReport.master" %>
...
<p>
            ...
            <Fields>
                ...
                <dx:PivotGridField Area="FilterArea"  AreaIndex="4" FieldName="comune" Caption="Comuni" ID="filter_Comuni" Visible="False" ></dx:PivotGridField>
                ...
                <dx:PivotGridField Area="FilterArea"  AreaIndex="8" FieldName="aslNotifica" Caption="Asl notifica"  ID="filter_asl" Visible="true" ></dx:PivotGridField>                             
                <dx:PivotGridField Area="FilterArea"  AreaIndex="9" FieldName="Regione" Caption="Regione"  ID="filter_regione" Visible="true" ></dx:PivotGridField>        
                <dx:PivotGridField Area="FilterArea"  AreaIndex="10" FieldName="vaccino" Caption="vaccino"  ID="filter_vaccino" Visible="true" ></dx:PivotGridField>                                    
            </Fields>          
            </dx:aspxpivotgrid>
