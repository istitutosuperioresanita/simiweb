<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Analisi.aspx.vb" Inherits="Iss_Analisi"   MasterPageFile="~/_MasterPage/Template.master" 
...
<p>
    <asp:RadioButtonList ID="TipodataRiferimento" runat="server"  CssClass="checkBox">        
                ...
                <asp:ListItem Text="data notifica" Value="5"></asp:ListItem>    </asp:RadioButtonList>
