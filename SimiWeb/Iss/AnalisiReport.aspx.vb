...
Partial Class Iss_AnalisiReport
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            ObjAnalisiDs.SelectParameters.Add("Asl", TypeCode.String, Nothing)
            ObjAnalisiDs.SelectParameters.Add("idRegione", TypeCode.String, Nothing)
            'ObjAnalisiDs.Select()
    ...
    Protected Sub reset_Click(sender As Object, e As System.EventArgs) Handles reset.Click
        ...
        grid.Fields("comune").Visible = False
        ...
        grid.Fields("Regione").Area = DevExpress.XtraPivotGrid.PivotArea.FilterArea
        grid.Fields("Regione").AreaIndex = 9

        grid.Fields("vaccino").Area = DevExpress.XtraPivotGrid.PivotArea.FilterArea
        grid.Fields("vaccino").AreaIndex = 10
