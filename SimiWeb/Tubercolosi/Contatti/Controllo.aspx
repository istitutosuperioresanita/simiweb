<%@ Page Title="" Language="VB" MasterPageFile="~/_MasterPage/Tubercolosi.master" AutoEventWireup="false" CodeFile="Controllo.aspx.vb" Inherits="Tubercolosi_Contatti_Controllo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenuto" Runat="Server">
    <div class="splitd"  >
        <div class="pag_link" ><!--a href="">
           home</a-->
           Simiweb -> Tubercolosi -> Contatto -->Controllo
        </div >       
            <br />
                <br />
                <p>
                <asp:Label ID="controlloAnagraficaLabel" runat="server" AssociatedControlID="cognome" CssClass="label" Width="150px">Controllo di</asp:Label>
                <asp:Label ID="controlloAnagrafica" runat="server" CssClass="Label"></asp:Label>
                </p>
                <p>
                ...
                <label class="sezione">Controllo</label>
                <hr />
                <p>
                    <asp:Label ID="DataControlloLabel" runat="server" AssociatedControlID="DataControllo" CssClass="label" Width="150px">Data controllo</asp:Label>
                    <asp:textbox ID="DataControllo" runat="server" CssClass="textBox"></asp:textbox>
                </p>
                <p>
                    <asp:Label ID="DataEffettivaLabel" runat="server" AssociatedControlID="DataEffettiva" CssClass="label" Width="150px">Data effettiva</asp:Label>
                    <asp:textbox ID="DataEffettiva" runat="server" CssClass="textBox"></asp:textbox> 
                </p>
                <p>
                    <asp:Label ID="farmaciLabel" runat="server" AssociatedControlID="farmaci" CssClass="label" Width="150px">Farmaci</asp:Label>
                    <asp:DropDownList ID="farmaci" runat="server" CssClass="dropdown">   
                ...
                <p>
                    <asp:Label ID="SintomiLabel" runat="server" AssociatedControlID="sintomi" CssClass="label" Width="150px">Sintomi</asp:Label>
                    <asp:DropDownList ID="sintomi" runat="server" CssClass="dropdown">   
                        <asp:ListItem Text="Selezionare..." Value=""></asp:ListItem>                                         
                        <asp:ListItem Text="Si" Value="Si"></asp:ListItem>
                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                    </asp:DropDownList>
                ...
                <p>
                    <asp:Label ID="emocromoLabel" runat="server" AssociatedControlID="emocromo" CssClass="label" Width="150px">Esito emocromo</asp:Label>
