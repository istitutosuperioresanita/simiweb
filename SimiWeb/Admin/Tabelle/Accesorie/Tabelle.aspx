<%@ Page Title="" Language="VB" MasterPageFile="~/_MasterPage/Admin.master" AutoEventWireup="false" CodeFile="Tabelle.aspx.vb" Inherits="Admin_Tabelle_Accesorie_Tabelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenuto" Runat="Server">
    <div class="splitd"  >
        <div class="pag_link" ><!--a href="">
           home</a-->
           Simiweb -> Admin -> Tabelle -> <b>Gestione Tabelle Accessorie</b>
        </div >
